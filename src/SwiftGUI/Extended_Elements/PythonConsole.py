    ...
    def _update_special_key(self,key:str,new_val:Any) -> bool|None:
        match key:
            case "error_text_color":
                ...
                self.tk_widget.tag_config("error", foreground=new_val)  # This wrong warning is only one of the things I love so much about tkinter
