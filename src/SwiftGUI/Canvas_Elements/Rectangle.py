...
class Rectangle(Canvas_Elements.BaseCanvasElement):
    defaults = sg.GlobalOptions.Canvas_Rectangle

    _create_method = "create_rectangle"
    ...
    _transfer_keys = {
        ...
        "infill_stipple": "stipple",    # Todo: Sometimes this works, sometimes it doesn't...
